...
const save_course = (e) => {
	...
	frappe.call({
		method: "erptech_lms.api.save_course",
		args: {
			tags: tags.join(", "),
			title: $("#title").val(),
			...
			course: $("#title").data("course")
				...
				: "",
			published: 1,
			custom_manufacturer: $("#manufacturer").prop("checked") ? 1 : 0,
			custom_wholeseller: $("#wholeseller").prop("checked") ? 1 : 0,
			custom_retail: $("#retail").prop("checked") ? 1 : 0,
			custom_services: $("#services").prop("checked") ? 1 : 0,
